...
class Figure_2D:
    ...
    def __init__(self, whatsearch: int, data_input: dict, variant: enum.Enum):
        ...
        '''self.Box_lines_page1 = {
            "Прямоугольник": {1: ("Сторона", "Диаметр", "Диагональ", "Площадь", "Периметр", "Угол α", "Угол β"),
                              # Стороны
                              2: ("Сторона a", "Сторона b", "Радиус", "Площадь", "Периметр", "Угол α", "Угол β"),
                              # Диагональ
                              3: ("Сторона a", "Сторона b", "Диагональ", "Площадь", "Периметр", "Радиус"),  # Периметр
                              4: ("Сторона a", "Сторона b", "Диагональ", "Радиус", "Периметр", "Угол β"),  # Площадь
                              5: ("Сторона a", "Сторона b", "Диагональ", "Площадь", "Периметр", "Угол α", "Угол β"),
                              # Окружность
                              6: ("Сторона a", "Сторона b", "Диагональ", "Угол β"),  # Угол а
                              7: ("Площадь", "Диагональ", "Угол α")}  # Угол b
        }'''
